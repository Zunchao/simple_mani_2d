function trans_3_joints_xy_jacobian = trans3jointsxy_jacobian(L, Theta1, Theta2, Theta3)
% 3rd joint endpoints
%{
...
%}
trans_3_joints_xy_jacobian=[ - L*sin(Theta1 + Theta2) - L*sin(Theta1) - L*sin(Theta1 + Theta2 + Theta3), - L*sin(Theta1 + Theta2) - L*sin(Theta1 + Theta2 + Theta3), -L*sin(Theta1 + Theta2 + Theta3);
